    ...
    for protein_id in elms:
        ...
        if protein in conserved:
            for elm in elms[protein_id]:
                if elm in conserved[protein] and elm in elm2pos:
                    ...
                    for [st, stp, seq] in elms[protein_id][elm]:
                        ...
                        if not new_seq in protein2elm2seq[protein][elm]:
                            protein2elm2seq[protein][elm][new_seq] = 0
                        protein2elm2seq[protein][elm][new_seq] += 1

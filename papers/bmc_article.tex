...
organized influenza protein sequences into groups based on the host
organism with which there were tagged, curation year, and strain. For
each flu protein, we only used groups that had over 50 protein
sequences. Figure 4 shows the strains and years that passed this
...
\section*{Figures}
  ...
  \subsection*{Figure 3 - Host phylogeny}
   ...
   \subsection*{Figure 4 - Flu protein sequence counts}
     For this study, we grouped flu protein sequences by flu protein,
     host organism, curation year, and subtype. We used groups with
     over 50 protein sequence instances. The $log_{10}$ of the sequence
     count is shown here.
...
\section*{Tables}
  \subsection*{Table 1 - Jensen-Shannon divergece between influenza groups and hosts}
    ...
    \subsection*{Table 2 - Testing flu-host hypothesis}
    Here is an example of a \emph{small} table in \LaTeX\ using  
    \verb|\tabular{...}|. This is where the description of the table 
    should go. \par \mbox{}
    \par
    ...
    Hypoth & True  &  False & True & False \\ \hline
         Unique & B2  & C3 & .. & .. \\ \hline
         Control & B2  & C3 & .. & .. \\ \hline
    \hline P-value & \multicolumn{2}{|c||}{...} & \multicolumn{2}{|c|}{...} \\ \hline
       \end{tabular}
       }

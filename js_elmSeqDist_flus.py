...
species = ('human', 'swine', 'equine', 'chicken', 'duck')
...
for host in species:
    ...
    with open('results/flu_elmdict_' + host) as f:
        for line in f:
...
out_file = 'plots/for_aydin_2/roundup_all/js.dendrogram.flu.png'
...
with open(tmp_r, 'w') as f:
    ...
    f.write("plot(h,hang=-1,labels=labels[1,],main='Influenza Dendrogram')\n")
    f.write('dev.off()\n')
